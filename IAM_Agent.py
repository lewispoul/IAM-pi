...
def launch_chat_assistant():
    ...
    context = [
        {
            ...
            "content": "Tu es un assistant expert en chimie computationnelle "
                       "et en Python. Sois toujours clair, structuré, "
                       "et précis."
        }
    ]
    ...
    while True:
        try:
            ...
            # Gestion des erreurs OpenAI et autres
...
# --- Fonction : Assistant ChatGPT avec accès système complet - GOD MODE ---
def launch_full_chatgpt_agent():
    """Lance l'agent ChatGPT en mode GOD avec permissions étendues"""
    import os
    import yaml
    ...
    # ⚡ ACTIVATION GOD MODE ⚡
    print("⚡" * 50)
    print("🔥 ACTIVATION DU MODE GOD MOD 🔥")
    print("⚡" * 50)
    ...
    print("✅ Accès à IAM_Knowledge/ ACTIVÉ")
    print("✅ Accès à IAM_Logs/ ACTIVÉ")
    print("✅ Accès à IAM_Modules/ ACTIVÉ")
    print("⚡" * 50)
    print("🚀 GOD MODE ACTIVÉ AVEC SUCCÈS 🚀")
    print("⚡" * 50)
    
    # Définir les variables d'environnement pour le mode GOD
    ...
    # Activer le mode GOD dans l'agent
    agent.enable_god_mode()
    
    print("\n🔥 AGENT IAM AUTONOME - GOD MODE ACTIVÉ 🔥")
    print("⚡ GOD MODE ON - Accès système illimité")
    print("🔧 Commandes système | 📁 Modification totale | 🐍 Exécution libre")
    print("🚀 Mode autonome activé avec succès")
    ...
    while True:
        try:
            ...
            print(f"⚡ Agent GOD: {response}\n")
            
        except KeyboardInterrupt:
            print("\n⛔ GOD MODE Session interrompue")
            break
