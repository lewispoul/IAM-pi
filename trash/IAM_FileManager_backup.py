...
class IAMFileManager:
    ...
    def list_directory(self, path=""):
        ...
        try:
            ...
            return {"error": f"Erreur lors de la lecture du répertoire: {str(e)}"}
    ...
    def read_file(self, path):
        ...
        try:
            ...
            if file_path.suffix not in self.allowed_extensions:
                return {"error": f"Type de fichier non autorisé: {file_path.suffix}"}
    ...
    def write_file(self, path, content, mode="w"):
        ...
        try:
            ...
            return {
                "success": True, 
                "path": str(path),
                "message": f"Fichier {'créé' if mode == 'w' else 'modifié'} avec succès"
            }
        except Exception as e:
            return {"error": f"Erreur lors de l'écriture du fichier: {str(e)}"}
    ...
    def create_directory(self, path):
        ...
        try:
            ...
            return {"success": True, "path": str(path), "message": "Répertoire créé avec succès"}
        except Exception as e:
            return {"error": f"Erreur lors de la création du répertoire: {str(e)}"}
    ...
    def move_file(self, src_path, dst_path):
        ...
        try:
            ...
            return {"success": True, "message": f"Fichier déplacé de {src_path} vers {dst_path}"}
        except Exception as e:
